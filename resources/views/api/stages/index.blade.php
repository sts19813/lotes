            ...
            $('#formStage').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        // ✅ Recargar DataTable
                        $('#stagesTable').DataTable().ajax.reload(null, false);

                        // ✅ Resetear formulario
                        $('#formStage')[0].reset();
                        $('#phaseSelect')
                            .prop('disabled', true)
                            .html('<option>Selecciona primero un Proyecto...</option>');

                        // ✅ SweetAlert OK
                        Swal.fire({
                            icon: 'success',
                            title: 'Etapa guardada',
                            text: 'La etapa se guardó correctamente.',
                            timer: 1800,
                    ...
                    error: function (err) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: err.responseJSON?.message || 'Ocurrió un error al guardar la etapa.'
                        });
                    }
                });
            });
